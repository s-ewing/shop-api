...
public class ProductSeedRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        product1.setCategories(List.of(ProductCategory.HATS));
        product1.setDepartments(List.of(ProductDepartment.MENS));
        ...
        product2.setCategories(List.of(ProductCategory.HATS));
        product2.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product3.setCategories(List.of(ProductCategory.HATS));
        product3.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product4.setCategories(List.of(ProductCategory.HATS));
        product4.setDepartments(List.of(ProductDepartment.WOMENS));
        ...
        product5.setCategories(List.of(ProductCategory.JACKETS));
        product5.setDepartments(List.of(ProductDepartment.MENS));
        ...
        product6.setCategories(List.of(ProductCategory.JACKETS));
        product6.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product7.setCategories(List.of(ProductCategory.JACKETS));
        product7.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product8.setCategories(List.of(ProductCategory.JACKETS));
        product8.setDepartments(List.of(ProductDepartment.WOMENS));
        ...
        product9.setCategories(List.of(ProductCategory.SHOES));
        product9.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product10.setCategories(List.of(ProductCategory.SHOES));
        product10.setDepartments(List.of(ProductDepartment.MENS));
        ...
        product11.setCategories(List.of(ProductCategory.SHOES));
        product11.setDepartments(List.of(ProductDepartment.WOMENS));
        ...
        product12.setCategories(List.of(ProductCategory.ACCESSORIES));
        product12.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product13.setCategories(List.of(ProductCategory.ACCESSORIES));
        product13.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
        ...
        product14.setCategories(List.of(ProductCategory.ACCESSORIES));
        product14.setDepartments(List.of(ProductDepartment.MENS, ProductDepartment.WOMENS));
